...
#brainstorm
#idea on how can do fixed variable for something like extdisk location prefill
#name="josh"
#read -e -i "$name" -p "enter name: " input
#name="${input:-$name}"
#echo $input
...
#function invoked later on when asking for user confirmation on certain tasks
